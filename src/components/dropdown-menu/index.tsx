...
} from "@azdias/ui/components/dropdown-menu/types";
            ...
            >
                <MenuPrimitive.Popup
                    ...
                    className={cn(
                        ...
                        + "data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95",
                        className
                    )}
                    {...props}
                />
...
export function DropdownMenuItem({ className, inset, variant = "default", ...props }: DropdownMenuItemProps) {
    return (
        <MenuPrimitive.Item
            ...
            className={cn(
                "group/dropdown-menu-item relative flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 "
                + "text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground "
                + "not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-7 "
                + "data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 "
                + "data-[variant=destructive]:focus:text-destructive "
                + "dark:data-[variant=destructive]:focus:bg-destructive/20 data-disabled:pointer-events-none "
    ...
    return (
        <MenuPrimitive.SubmenuTrigger
            ...
            className={cn(
                ...
                + "not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-7 "
                + "data-popup-open:bg-accent data-popup-open:text-accent-foreground data-open:bg-accent "
...
export function DropdownMenuSubContent({
    ...
    return (
        <DropdownMenuContent
            ...
            className={cn(
                "w-auto min-w-24 rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1 "
                + "ring-foreground/10 duration-100 data-[side=bottom]:slide-in-from-top-2 "
    ...
    return (
        <MenuPrimitive.CheckboxItem
            ...
            className={cn(
                ...
                + "focus:**:text-accent-foreground data-inset:pl-7 data-disabled:pointer-events-none "
                + "data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 "
                + "[&_svg:not([class*='size-'])]:size-4",
                className
            )}
...
export function DropdownMenuRadioItem({
    ...
    return (
        <MenuPrimitive.RadioItem
            ...
            data-inset={inset}
            className={cn(
                "relative flex cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden "
                + "select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground "
