...
import { Label } from "@azdias/ui/components/label";
...
import type {
    ...
    FieldSetProps,
    FieldTitleProps,
} from "@azdias/ui/components/field/types";
    ...
    return (
        <Label
            ...
            className={cn(
                ...
                + "group-data-[disabled=true]/field:opacity-50 has-data-checked:border-primary/30 "
                + "has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-lg "
                + "has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 dark:has-data-checked:border-primary/20 "
