...
import type {
    ...
    TooltipTriggerProps,
} from "@azdias/ui/components/tooltip/types";
            ...
            >
                <TooltipPrimitive.Popup
                    ...
                    className={cn(
                        ...
                        + "rounded-md bg-foreground px-3 py-1.5 text-xs text-background has-data-[slot=kbd]:pr-1.5 "
                ...
                >
                    ...
                    <TooltipPrimitive.Arrow
                        className={
                            "z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-xs bg-foreground "
                            + "fill-foreground data-[side=bottom]:top-1 data-[side=inline-end]:top-1/2! "
                            ...
                            + "data-[side=left]:-right-1 data-[side=left]:-translate-y-1/2 data-[side=right]:top-1/2! "
