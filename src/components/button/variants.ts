...
export const buttonVariants = cva(
    ...
    + "aria-invalid:border-destructive aria-invalid:outline-solid aria-invalid:outline-destructive/20 "
    + "dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none "
    + "[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 focus-visible:outline-solid",
    {
        variants: {
            variant: {
                ...
                secondary: "bg-secondary text-secondary-foreground "
                    + "hover:bg-[color-mix(in_oklch,var(--secondary),var(--foreground)_5%)] aria-expanded:bg-secondary "
                    + "aria-expanded:text-secondary-foreground",
                ghost: "hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground "
                    + "dark:hover:bg-muted/50",
                destructive: "bg-destructive/10 text-destructive hover:bg-destructive/20 "
                    + "focus-visible:outline-destructive/20 dark:bg-destructive/20 "
                    + "dark:hover:bg-destructive/30 dark:focus-visible:outline-destructive/40",
