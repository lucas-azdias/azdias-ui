    ...
    return (
        <InputPrimitive
            ...
            className={cn(
                ...
                + "text-base transition-colors outline-none file:inline-flex file:h-6 file:border-0 "
                ...
                + "dark:disabled:bg-input/80 dark:aria-invalid:ring-destructive/40 focus-visible:outline-solid",
                className
            )}
            {...props}
        />
