...
import type { CardItemProps, CardProps } from "@azdias/ui/components/card/types";
    ...
    return (
        <div
            ...
            className={cn(
                ...
                + "py-(--card-spacing) text-sm text-card-foreground border "
...
export function CardHeader({ className, ...props }: CardItemProps) {
    return (
        <div
...
export function CardTitle({ className, ...props }: CardItemProps) {
    return (
        <div
...
export function CardDescription({ className, ...props }: CardItemProps) {
    return (
        <div
...
export function CardAction({ className, ...props }: CardItemProps) {
    return (
        <div
...
export function CardContent({ className, ...props }: CardItemProps) {
    return (
        <div
...
export function CardFooter({ className, ...props }: CardItemProps) {
    return (
        <div
