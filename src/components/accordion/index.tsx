...
} from "@azdias/ui/components/accordion/types";
        ...
        <AccordionPrimitive.Header className="flex">
            <AccordionPrimitive.Trigger
                ...
                className={cn(
                    ...
                    + "hover:underline focus-visible:outline-solid aria-disabled:pointer-events-none "
                    + "**:data-[slot=accordion-trigger-icon]:ml-auto **:data-[slot=accordion-trigger-icon]:size-4 "
                    + "**:data-[slot=accordion-trigger-icon]:text-muted-foreground aria-disabled:opacity-50",
                    className
                )}
                {...props}
            >
